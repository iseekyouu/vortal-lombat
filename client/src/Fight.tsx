...
interface FightProps {
  player1: Fighter;
  player2: Fighter;
  setPlayer1: React.Dispatch<React.SetStateAction<Fighter>>;
  setPlayer2: React.Dispatch<React.SetStateAction<Fighter>>;
}
...
const Fight: React.FC<FightProps> = ({ player1, player2, setPlayer1, setPlayer2 }) => {
  ...
  const handleRound = (round: Round) => {
    ...
    setPlayer1((prev) => ({
      ...prev,
      health: prev.health - round.p2dmg,
    }));

    setPlayer2((prev) => ({
      ...prev,
      health: prev.health - round.p1dmg,
    }));
  };
